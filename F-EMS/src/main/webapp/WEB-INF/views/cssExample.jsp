...
<body>
	<div style="position: inherit; background-color: #fff; height:1500px import!; z-index: 100;">
		<h1>작업중</h1>	<input type="button" class="btn-lg btn-color" value="이전" onclick="history.go(-1);">
		※ 텍스트 크기는 13px를 기본으로 하고있음<br/><br/>
		...
		<input type="button" class="def-btn" value="기본"><br />
		...
		<input type="button" class="def-btn btn-sm btn-color" value="조회">&nbsp;&nbsp;조회, 검색 등<br />
		<input type="button" class="def-btn btn-sm" value="체크">&nbsp;&nbsp;테이블 안에서 특수하게 사용할 버튼<br />
