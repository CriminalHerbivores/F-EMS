...
<body>
	...
	---------------<br/>
	<a href="<%=request.getContextPath() %>/type_login">로그인형</a><br/>
	<a href="<%=request.getContextPath() %>/type_multi">복합형</a><br/>
	<a href="<%=request.getContextPath() %>/type_board">게시판형</a><br/>
	<a href="<%=request.getContextPath() %>/type_menu">메뉴강조형</a><br/>
