...
<h2>${lctre_Search.lu_Lctre_Nm } 평가서</h2><br/>
	<form name="formm" method="post">
		...
		<tr>
		<td>2번 강의 내용이 강의 계획서대로 진행되었다.</td>
		...
		<td>3번 교제선택(또는 보조자료 제시)이 적절하였다.</td>
		...
		<td>5번 교과목에 알맞은 교육메체가 적절히 활용되었다.</td>
		...
		<td>6번 수업을 위한 적절한 교육메체가 준비되었다.</td>
		...
		<td>8번 강의를 위한 자료와 정보 수집이 수월하였다.</td>
		...
		<td>11번 나는 이 수업을 통하여 많은 지식을 얻었다.</td>
		...
		<td>12번 나는 이 수업을 다른 학생에게 추천하고 싶다.</td>
		...
		<td>13번 나는 이 수업을 전체적으로 우수하다고 평가한다.</td>
