...
<h2>강의 공지 게시판</h2><br/>
	<form name="formm" method="post" action="detailBbs_Gnt">
		<table class="def-table-full tb-border" style="text-align:left;">
			...
			<tr>
				<th>내용</th>
				<td colspan="3" class="text-left"><textarea rows="8" cols="65" name="ln_Cn" readonly="readonly" style="width:100%;" class="text-non-border">${lctre_Notice_Gnt.ln_Cn}</textarea><br></td>
			</tr>
			<tr>
