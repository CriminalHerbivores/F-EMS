...
<table class="def-table-full tb-border table-hover">
	<tr>
		<th>제목</th>
		<td><input type="text" name="lq_Sj"  size="64" class="def-input-text-full custom-form-control"></td>
	</tr>
	<tr>
		<th>내용</th>
		<td><textarea rows="8" cols="65" name="lq_Cn" class="def-input-text-full custom-form-control"></textarea></td>
	</tr>
</table>
