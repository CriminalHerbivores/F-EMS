	...
	<div id="detailBbs_Gnt" style="float: left;">
		<form name="formm" method="post" action="detailBbs_Gnt">
			...
			<table class="def-table-full tb-border table-hover"
				...
				<tr>
					<th>내용</th>
					<td colspan="3" style="text-align: left;"><textarea rows="8"
							cols="65" name="ln_Cn" readonly="readonly">${lctre_Qna_Gnt.lq_Cn }</textarea><br></td>
				</tr>
				<tr>
					<th>답변</th>
					<td colspan="3" style="text-align: left;"><textarea rows="8"
							cols="65" name="lq_Reply" readonly="readonly">${lctre_Qna_Gnt.lq_Reply }</textarea><br></td>
				</tr>
		...
		<div id="buttons" style="float: right">
			<sec:authorize access="hasRole('ROLE_STD')">
				<a
					href="updateLctre_Qna?lq_Bbs_No=${lctre_Qna_Gnt.lq_Bbs_No}&table_Nm=${lctre_Qna_Gnt.table_Nm}&tpage=${tpage}">
					<input type="button" value="수정" class="def-btn btn-md btn-color">
				</a>
				<input type="button" class="def-btn btn-md btn-color"
					data-target="#layerpop" data-toggle="modal" value="삭제">
			</sec:authorize>
