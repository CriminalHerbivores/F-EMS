...
<body>
	...
	<form name="formm" method="post" action="detailBbs_Gnt">
		<table class="def-table-full tb-border" style="text-align:left;">
			...
			<tr>
				<th>내용</th>
				<td colspan="3" style="text-align: left;"><textarea rows="8" cols="65" name="ld_Cn" readonly="readonly" style="width:100%;" class="text-non-border">${lctre_Date_Gnt.ld_Cn }</textarea></td>
			</tr>
			<tr>
				<td class="text-right" colspan="4">
				<!--버튼들  -->
				<sec:authorize access="hasRole('ROLE_PRO')">
				<a href="updateLctre_Date?ld_Bbs_No=${lctre_Date_Gnt.ld_Bbs_No}&table_Nm=${lctre_Date_Gnt.table_Nm}&tpage=${tpage}"> <input type="button" value="수정" class="def-btn btn-md btn-color"> </a> 
				<input type="button" class="def-btn btn-md btn-color" data-target="#layerpop" data-toggle="modal" value="삭제"> 
				</sec:authorize>
				<a href="dateList?tpage=${tpage}&table_Nm=${lctre_Date_Gnt.table_Nm }"> <input type="button" class="def-btn btn-md btn-color" value="목록">
				</a>
				</td>
			</tr>
		</table>
