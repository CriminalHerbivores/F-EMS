...
<table class="def-table-auto tb-border table-hover">
	...
	<tr>
      	<th>등록양식</th>
      	<td><a href="<%=request.getContextPath() %>/download/file/list?filename=교수등록.xlsx">엑셀양식</a></td>
      	<th>업로드</th>
      	<td colspan="3"><input type="file" name="f"></td>
      </tr>
</table>
   <table class="def-table-full"><tr><td style="text-align: right;">
   <button type="button" class="def-btn btn-sm btn-color" onclick="submit_profsr(this.form)">등록</button>
