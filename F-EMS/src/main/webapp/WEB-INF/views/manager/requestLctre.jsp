...
<tr><th colspan="4">개설 강의 정보</th></tr>
	<tr>
		...
		<th>개설학과전공</th>
		<td><input type="text" class="def-input-text-full custom-form-control" name="sit_Subjct" readonly>
	 ...
	 <tr>
	 	<th>교과목명</th>
	 	<td><input type="text" class="def-input-text-md custom-form-control" name="lu_Lctre_Nm" readonly>&nbsp;<input type="button" class="def-btn btn-search btn-color" value="검색" onclick="searchLctre()"></td>
	 	<th>강의번호</th>
	 	<td><input type="text" class="def-input-text-full custom-form-control" name="lc_Lctre_Code" readonly></td>
	 </tr>
	 
	 <tr>
	 	<th>구분</th>
	 	<td><input type="text" class="def-input-text-md custom-form-control" name="lu_Compl_Se" readonly>&nbsp;&nbsp;
	 	...
	 	<th>이수학점</th>
	 	<td><input type="text" class="def-input-text-full custom-form-control" name="lu_Pnt" readonly></td>
	 </tr>
	 <tr>
	 	<th>학년</th>
	 	<td><input type="text" class="def-input-text-md custom-form-control" name="lu_Grade" readonly> 학년</td>
	 	
	 	<th>선행과목</th>
	 	<td><input type="text" class="def-input-text-full custom-form-control" name="lu_Presubjct" readonly></td>
	 </tr>
	...
	<%-- <c:forEach items="${profsrVO}" var="profsr"> --%>
	 	<th>교수이름</th>
	 	<td><input type="text" class="def-input-text-full custom-form-control" value="${profsrVO.pr_Nm}" readonly>
	 	<input type="hidden" name="lc_Profsr_No" value="${profsrVO.pr_Profsr_No}"></td>   
	 	
	 	<th>담당교수전화</th>
	 	<td><input type="text" class="def-input-text-full custom-form-control" value="${profsrVO.pr_Profsr_Tlphon_No}" readonly>
	 	</td>
	  ...
	  <tr>
	 	<th>교수 이메일 주소</th>
	 	<td><input type="text" class="def-input-text-full custom-form-control" value="${profsrVO.pr_Email}" readonly></td>
	...
	<tr><th colspan="4">강의 상세 정보</th></tr>
	 ...
	 <tr>
	 	<th>주간 강의 요일</th>
	 	<td><input type="text" class="def-input-text-full custom-form-control" name="lc_Wik_Lctre_Dayweek"></td>
	 	<th>강의시간</th>
	 	<td><input type="text" class="def-input-text-full custom-form-control" name="lc_Lctre_Time"></td>
	   ...
	   <tr>
	     ...
	     <tr>
	     	<td><input type="text" class="def-input-text-full custom-form-control"  name="la_Midex"></td>
	     	<td><input type="text" class="def-input-text-full custom-form-control"  name="la_Fnex"></td>
	     	<td><input type="text" class="def-input-text-full custom-form-control"  name="la_Indvdl_Task"></td>
	     	<td><input type="text" class="def-input-text-full custom-form-control"  name="la_Team_Task"></td>
	     	<td><input type="text" class="def-input-text-full custom-form-control"  name="la_Presnatn"></td>
	     	<td><input type="text" class="def-input-text-full custom-form-control"  name="la_Atend"></td>
	     	<td><input type="text" class="def-input-text-full custom-form-control"  name="la_Attd"></td>
	     </tr>
	      </table>
	 ...
	 <input type="button" class="def-btn btn-sm btn-color"  value="취소" onclick="go.history(-1)"><br />
	 </td></tr></table>
	 </form>
	 <br/><br/><br/>
</body>
