...
<body>
<article>
<form id="modify_subject" action="/fems/admin/main" method="post" name="formm">
<h1>학부·학과 수정</h1>
...
<table class="def-table tb-border">
		...
		<tr><td>단과대학 수정</td><td><input type="text" class=".def-input-text-lg"></td><td><input type="button" class="def-btn" value="중복 확인"></td><td>여기 아작스</td></tr>	
		...
		<tr><td>학부 수정</td><td><input type="text" class=".def-input-text-lg"></td><td><input type="button" class="def-btn" value="중복 확인"></td><td>여기 아작스</td></tr>	
		<tr><td>학과 선택</td><td colspan="3">
				<select name="선택" class="combobox-lg">
					<option value="02">02</option>
					<option value="031">031</option>
					<option value="032">032</option>
		...
		<tr><td>학과 수정</td><td><input type="text" class=".def-input-text-lg"></td><td><input type="button" class="def-btn" value="중복 확인"></td><td>여기 아작스</td></tr>	
		<tr><td>학과 전화번호</td><td>
