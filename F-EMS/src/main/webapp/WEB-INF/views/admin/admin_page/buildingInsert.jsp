...
<h1>건물 등록</h1>
	...
	<table class="def-table-auto tb-border table-hover">
		<tr><td>건물 번호</td><td><input type="text" class=".def-input-text-lg" name="bd_No"></td><td><input type="button" class="def-btn btn-sm btn-color" value="중복 확인"></td><td>여기에 사용가능여부</td></tr>
		<tr><td>건물 이름</td><td><input type="text" class=".def-input-text-lg" name="bd_Nm"></td><td><input type="button" class="def-btn btn-sm btn-color" value="중복 확인"></td><td>여기에 사용가능여부</td></tr>
