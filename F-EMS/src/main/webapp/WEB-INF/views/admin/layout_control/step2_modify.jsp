...
<form id="step2_modify" action="/fems/admin/step3_modify" method="post" name="formm">
...
<div class="set-layout-side">
	<!-- 여기 화살표 넣을거임 -->
	<input type="image" src="<%=request.getContextPath()%>/resources/images/right-arrow.png" alt="Submit" onclick="go_step3_modify()"><br/>
