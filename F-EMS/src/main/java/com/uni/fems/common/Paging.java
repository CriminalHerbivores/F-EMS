...
public class Paging {
	 ...
	 * @param tpage 현재 페이지
	 * @param totalRecord 테이블에 있는 데이터의 총 개수
	 * @param view_rows 페이지의 개수
	 * @param counts 한 페이지에 나타낼 개수
	 * @return {counts,첫페이지, 마지막페이지}
	 * </pre>
	 */
	public int[] row(int tpage, int totalRecord, int view_rows, int counts){
		int startRow = -1;
		int endRow = -1;
	 ...
	 * </pre>
	 */
	public String pageNumber(int tpage, int totalRecord, String path, String key, int view_rows, int counts) 
			throws SQLException {
	 ...
	 * </pre>
	 */
	public String pageNumber(PageRequest p, int view_rows, int counts)	throws SQLException {
	 ...
	 * </pre>
	 */
	public String commentPageNumber(int cpage, int totalRecord, String path, String key, int view_rows, int counts) 
			throws SQLException {
